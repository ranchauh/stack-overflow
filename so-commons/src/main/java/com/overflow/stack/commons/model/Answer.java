...
public class Answer {
    ...
    Answer(String answerId, String questionId, String answerText, String parentAnswerId, long voteCount, long createTimestamp, long updateTimestamp, String postedBy, List<String> imageIds, List<String> videoIds) {
